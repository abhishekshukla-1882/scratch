...
const GetFeedDocument = ({props,api_select,operation}) =>{
    ...
    return (
        <>
          <div className="card-header bg-primary text-light"><center><b>Authentication</b></center></div>
             ...
             Feed Doc Id: &nbsp;&nbsp;<input type="text" name="feed_Doc_id" value={MultiInput.feed_Doc_id} onChange={handleInput} class="form-control"/><br/>
             amzn1.tortuga.3.619e5ef4-84d8-40d0-bcba-71ca7ee7c7b8.T3F6DERFJWKVOC
             <b>Type</b>
