...
const CreateFeedDocument = ({props,api_select,operation}) => {
    // <Form data={'no data'} />
        ...
        <>
            ...
            <div className="card-body">
                <p className="card-text ">
                    ...
                    Content: &nbsp;&nbsp;<input type="text" name="content" value={MultiInput.content} onChange={handleInput} class="form-control" /><br />
                    <b>Type</b>
