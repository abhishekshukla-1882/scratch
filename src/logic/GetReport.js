...
const GetReport = ({props,api_select,operation}) =>{
    ...
    return (
        <>
          <div className="card-header bg-primary text-light"><center><b>Authentication</b></center></div>
             ...
             Report Id : &nbsp;&nbsp;<input type="text" value={MultiInput.reportId}  name="reportId" onChange={handleInput} class="form-control"/><br/>
