...
const CreateReport = ({props,api_select,operation}) =>{
const [MultiInput, setuserInput] = useState(
    ...
    return (
        <>
            <div className="card-header bg-primary text-light"><center><b>Authentication</b></center>
                ...
                <select className='mx-5' name="type" value={MultiInput.type}  onChange={handleInput}aria-label="Default select example">
                        ...
                        <option value="GET_XML_BROWSE_TREE_DATA">GET_XML_BROWSE_TREE_DATA</option>
                    </select>
